...
class UserManager(models.Manager):
    def add_user(self, postData):
        ...
        if errors:
            ...
            user = self.create(first_name=postData['first_name'], last_name=postData['last_name'], alias=postData['alias'], email=postData['email'], pokehistory=0, password=hashed_password)
...
class User(models.Model):
    ...
    pokehistory = models.IntegerField()
